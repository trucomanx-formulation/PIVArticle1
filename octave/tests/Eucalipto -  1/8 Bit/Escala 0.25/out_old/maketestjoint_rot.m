...
hp1=plot(t,p0(1:N),'-<',t,p1(1:N),'-o',t,p2(1:N),'-s',t,exp(-(t/15).^2),'--.');
grid
%grid minor
hl1=legend('Analysis region 0','Analysis region 1','Analysis region 2','exp(-(angle/15)^2)','location','southwest');
